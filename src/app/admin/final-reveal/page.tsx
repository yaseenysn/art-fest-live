    ...
    <div className="min-h-screen bg-slate-50 p-8 pb-32">
      <div className="max-w-6xl mx-auto space-y-8">
        ...
        <div className="flex items-center justify-between bg-white p-6 rounded-2xl shadow-sm border border-slate-200">
          <div className="flex items-center space-x-4">
            ...
            <div>
              ...
              <p className="text-slate-500 font-medium mt-1">Standalone cinematic reveal control</p>
            </div>
          </div>
          <Link 
            href="/admin/display" 
            className="flex items-center space-x-2 text-slate-600 bg-slate-100 hover:bg-slate-200 px-6 py-3 rounded-xl font-bold transition-colors"
          >
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
          {/* Controls */}
          <div className="bg-white rounded-2xl shadow-sm border border-slate-200 p-8 flex flex-col space-y-8">
            <h2 className="text-xl font-bold text-slate-800 uppercase tracking-wide border-b pb-4">Configuration</h2>
            ...
            <div className="space-y-6">
              <div>
                ...
                <input
                  ...
                  className="w-full px-4 py-3 rounded-xl border border-slate-300 bg-slate-50 focus:bg-white focus:outline-none focus:ring-2 focus:ring-indigo-500/50 focus:border-indigo-500 transition-all font-bold text-slate-900 text-lg uppercase"
                />
              </div>
            ...
            <div className="pt-8 border-t border-slate-200 space-y-4">
              <button
                ...
                className="w-full flex items-center justify-center space-x-2 bg-slate-800 text-white rounded-xl py-4 font-black uppercase tracking-widest text-sm hover:bg-slate-700 transition-colors shadow-md"
              >
              ...
              <button
                ...
                disabled={isStarting}
                className="w-full flex items-center justify-center space-x-2 bg-emerald-600 text-white rounded-xl py-4 font-black uppercase tracking-widest text-lg hover:bg-emerald-500 transition-colors shadow-lg shadow-emerald-600/30 disabled:opacity-50"
              >
              ...
              <button
                ...
                className="w-full flex items-center justify-center space-x-2 bg-red-600 text-white rounded-xl py-4 font-black uppercase tracking-widest text-sm hover:bg-red-500 transition-colors shadow-md disabled:opacity-50"
              >
          ...
          {/* Preview Panel */}
          <div className="lg:col-span-2 bg-slate-900 rounded-2xl shadow-xl overflow-hidden border border-slate-800 flex flex-col relative aspect-video">
             ...
             <div className="w-full h-full relative overflow-hidden bg-black flex items-center justify-center">
                {previewActive ? (
                  ...
                  <div className="text-slate-600 font-bold uppercase tracking-widest flex flex-col items-center">
