...
export default function AnnouncementOverlay({ announcement }: { announcement: IAnnouncement }) {
  return (
    <motion.div
      ...
      animate={{ opacity: 1 }}
      exit={{ opacity: 0 }}
      className="absolute inset-0 z-50 flex justify-center items-center w-full h-full bg-[#751121] overflow-y-auto md:overflow-hidden select-none px-4 md:px-8 py-4 md:py-0"
      style={{
    ...
    >
      ...
      <motion.div
        ...
        className="relative w-full max-w-[1200px] min-h-[50vh] bg-[#fdfbf7] rounded-[30px] md:rounded-[50px] shadow-[15px_20px_40px_rgba(0,0,0,0.6),inset_-5px_-5px_15px_rgba(0,0,0,0.05),inset_5px_5px_15px_rgba(255,255,255,1)] p-2 md:p-6 z-10 mt-0 md:mt-[-5%]"
      >
        ...
        <div className="border-[4px] md:border-[6px] border-[#e2d1bb] rounded-[20px] md:rounded-[35px] p-4 sm:p-8 md:p-20 flex flex-col items-center justify-center relative bg-white/50 h-full w-full">
          ...
          >
            ...
            <p className="text-[clamp(42px,6vw,72px)] text-[#111827] font-extrabold leading-snug md:leading-[1.4] px-4 md:px-16 whitespace-pre-wrap break-words drop-shadow-sm">
              {announcement.message}
            </p>
          </motion.div>
        </div>
      ...
      >
        <div className="relative">
          ...
          <motion.div
            ...
            className="absolute -top-8 -left-8 md:-top-10 md:-left-10 flex flex-col gap-2 md:gap-4 rotate-[25deg] z-10"
          >
            <div className="w-8 h-2 md:w-12 md:h-3 bg-white/90 rounded-full rotate-[-45deg] shadow-lg" />
            <div className="w-8 h-2 md:w-12 md:h-3 bg-white/90 rounded-full -mt-2 md:-mt-4 rotate-[-20deg] shadow-lg -translate-x-4 md:-translate-x-6" />
            <div className="w-8 h-2 md:w-12 md:h-3 bg-white/90 rounded-full -mt-1 rotate-[5deg] shadow-lg -translate-x-2 md:-translate-x-3" />
          </motion.div>
          ...
          <img
            src="/megaphone.jpg"
            alt="Megaphone"
            className="w-[140px] md:w-[220px] mix-blend-multiply contrast-125 saturate-150 relative z-20"
          />
        </div>
      </motion.div>
    </motion.div>
